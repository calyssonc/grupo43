<header class="flex justify-center items-center md:justify-between p-4 pb-0 shadow-lg md:pb-4">
    ...
    <nav class="w-full font-bold">
      <ul class="flex flex-col md:flex-row items-center">
        ...
        <li class="md:ml-4 mt-2 md:mt-0 w-full">
            <div class="flex flex-nowrap w-full justify-center md:justify-end">
                <input class="block focus:border-orange p-2 rounded-full shadow-inner max-w-4xl" placeholder="Pesquisa..." type="text">
                <button>
